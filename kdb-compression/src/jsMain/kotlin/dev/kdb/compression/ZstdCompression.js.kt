...
public actual object ZstdCompression {
    public actual fun compress(input: ByteArray, level: Int): ByteArray = ZstdCompressionNative.compress(input)

    public actual fun decompress(input: ByteArray, maxOutputSize: Int): ByteArray =
        ZstdCompressionNative.decompress(input, maxOutputSize)
}

internal object ZstdCompressionNative {
